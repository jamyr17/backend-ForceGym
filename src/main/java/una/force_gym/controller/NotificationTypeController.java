...
import una.force_gym.service.NotificationTypeService;
...
public class NotificationTypeController {
    ...
    @PostMapping("/add")
    public ResponseEntity<ApiResponse<String>> addNotificationType(@RequestBody NotificationTypeDTO notificationTypeDTO) {
        int result = notificationTypeService.addNotificationType(
            notificationTypeDTO.getName(), 
            notificationTypeDTO.getParamLoggedIdUser()
        );
    ...
    @PutMapping("/update")
    public ResponseEntity<ApiResponse<String>> updateNotificationType(@RequestBody NotificationTypeDTO notificationTypeDTO) {
        int result = notificationTypeService.updateNotificationType(
            notificationTypeDTO.getIdNotificationType(), 
            notificationTypeDTO.getName(),
            notificationTypeDTO.getIsDeleted(),
            notificationTypeDTO.getParamLoggedIdUser()
        );
    ...
    @DeleteMapping("/delete/{idNotificationType}")
    public ResponseEntity<ApiResponse<String>> deleteNotificationType(@PathVariable("idNotificationType") Long idNotificationType, @RequestBody ParamLoggedIdUserDTO paramLoggedIdUser) {
        int result = notificationTypeService.deleteNotificationType(idNotificationType, paramLoggedIdUser.getParamLoggedIdUser());
